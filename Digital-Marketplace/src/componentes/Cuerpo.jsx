...
import {MoonIcon} from "../elementos/MoonIcon";
import {SunIcon} from "../elementos/SunIcon";
import "../css/bodyCuerpo.css"
      ...
      <div className="divCardPadre">
        ...
        <div className="card" style={{ width: "18rem" }}>
          ...
          <div className="card-body card-body-border">
            ...
            <Button radius="full" className="bg-gradient-to-tr from-pink-500 to-purple-500 text-white shadow-lg">Ver mas<i class="bi bi-plus-square-dotted"></i></Button>
            </div>
          </div>
        </div>
